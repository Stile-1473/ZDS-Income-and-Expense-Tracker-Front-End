        ...
        <div className="card-elevated p-4 sm:p-6 w-full animate-slideUp">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4 mb-6">
                ...
                <div className="flex items-center justify-start sm:justify-end gap-2 w-full sm:w-auto flex-wrap">
                    <button className="flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg text-xs sm:text-sm font-medium bg-neutral-100 hover:bg-neutral-200 text-neutral-700 transition-all active:scale-95 flex-1 sm:flex-none">
                        <Mail size={16} />
                        Email
                    </button>
